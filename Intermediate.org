...
* Abstract
In this the co-simulation speed of 
...
Design flow originates at the system level
...
The sequential nature of the SystemC's discrete event simulation engine is a limiting factor for complex 

poor simulation performance often limits the scope and depth of the design decisions that can be evaluated.

Parallelizing the simulation and preserving causality is a challenging

_3. Why was this problem worth a Master's thesis project?_
    Why no one else solved it yet?

_4. How did you solve the problem?_
Using prior art parallel simulation distributed high performance computing

where the designer can maintain

translation


5. Results/Conclusions/Consequences/Impact: 

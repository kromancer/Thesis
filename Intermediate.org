...
In unit [[SystemC and TLM]] we have a rudimentary look at what SystemC is.
In the units [[Problem Statement]] and [[Objectives]] the problem statement and the objectives of this Master's Thesis are presented.
...
As mentioned in the previous unit, a TLM can be thought of as a platform model, or *virtual platform*, where an application can/is mapped.
It is the model that facilitates co-simulation of hardware and software.
The notion of the transaction as an abstraction of communication will be explained in later units.
